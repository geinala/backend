...
async def clean_tuning_experiment_uploaded_rows(tuning_experiment_id: str):
    job = get_current_job()
    ...
    try:
        ...
        data_cleaning_service = TuningExperimentDataCleaningService(
            tuning_experiment_repository=tuning_experiment_repository,
            tuning_experiment_uploaded_row_repository=tuning_experiment_uploaded_row_repository
        )

        result = await data_cleaning_service.run(tuning_experiment_id=tuning_experiment_id)
