...
class JOB_PREFIXES_ENUM(str, Enum):
    ...
    TUNING_EXPERIMENT_JOB_PROCESSING_DATA = JobType.HEAVY.value + "-" + "tuning_experiment_process_files"
    TUNING_EXPERIMENT_JOB_CLEANING_DATA = JobType.HEAVY.value + "-" + "tuning_experiment_clean_uploaded_rows"
    TUNING_EXPERIMENT_JOB_GEOCODING = JobType.HEAVY.value + "-" + "tuning_experiment_geocoding"
